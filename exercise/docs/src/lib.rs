...
//! A pumpkin is a cultivar of winter squash ...
...
impl Pumpkin {
    /// smash the pumpkin
    ///
    /// Note: once it is smashed, it can't be used for pie 🤷‍♂️
    pub fn smash(self) {}
}
...
/// for the "orangeness" field in the [`Pumpkin`] struct
